...
<html>
    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide text-center img-fluid" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\note11.jpg"   alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide img-fluid w-100" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\portada5.jpg"  width="100" height="100" alt="Second slide">
            <div class="container">
      ...
      <div class="container marketing bg-light">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle w-100" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\note8.jpg" alt="imagen Notebook" width="140" height="140">
            <h2 class="text-white">Heading</h2>
            <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\note7.jpg" alt="imagen Notebook " width="140" height="140">
            <h2 class="text-white">Heading</h2>
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\note.jpg" alt="imagen Notebook" width="140" height="140">
            <h2 class="text-white">Heading</h2>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto img-thumbnail" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\asus2.jpg" alt="Generic placeholder image">
          </div>
        </div>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto img-thumbnail" src="C:\Users\casta\Documents\NetBeansProjects\Bootstraps4\web\img\hp.jpg" alt="Generic placeholder image">
          </div>
        </div>
